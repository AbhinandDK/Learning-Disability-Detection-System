...
def draw(frame,bb,keypoints):
    ...
    cv2.circle(frame, (keypoints[2], keypoints[7]),2,yellow,2)
    cv2.circle(frame, (keypoints[3], keypoints[8]),2,yellow,2)
    cv2.circle(frame, (keypoints[4], keypoints[9]),2,yellow,2)
